...
import { remove } from "../components/redux/Slice/CartSlice";
import { toast } from "react-hot-toast";
import { price } from "../components/redux/Slice/TotalPrice";
  ...
  return (
    <div className="flex items-center p-2 md:p-5 justify-between   mt-2 mb-2 md:mx-5 ">
      <div className="flex flex-col md:flex-row p-0 md:p-3 gap-5 items-center">
        <div className="w-[30%]">
          <img className="object-cover" alt="" src={item.primaryImage} />
        </div>
        <div className="md:ml-10 self-start space-y-5 w-[100%] md:w-[70%]">
          <h1 className="text-xl text-slate-700 font-semibold">{item.type}</h1>
